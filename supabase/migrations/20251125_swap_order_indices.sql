...
BEGIN
    ...
    SELECT order_index INTO topic1_order FROM topics WHERE id = topic1_id;
    SELECT order_index INTO topic2_order FROM topics WHERE id = topic2_id;
    ...
    UPDATE topics SET order_index = -1 WHERE id = topic1_id;
    
    -- Step 2: Set second topic to first topic's original order
    UPDATE topics SET order_index = topic1_order WHERE id = topic2_id;
    
    -- Step 3: Set first topic to second topic's original order
    UPDATE topics SET order_index = topic2_order WHERE id = topic1_id;
...
BEGIN
    -- Get current order indices
    SELECT order_index INTO subject1_order FROM subjects WHERE id = subject1_id;
    SELECT order_index INTO subject2_order FROM subjects WHERE id = subject2_id;
    ...
    -- Perform atomic swap
    UPDATE subjects SET order_index = -1 WHERE id = subject1_id;
    UPDATE subjects SET order_index = subject1_order WHERE id = subject2_id;
    UPDATE subjects SET order_index = subject2_order WHERE id = subject1_id;
END;
$$;
...
BEGIN
    -- Get current order indices
    SELECT order_index INTO level1_order FROM levels WHERE id = level1_id;
    SELECT order_index INTO level2_order FROM levels WHERE id = level2_id;
    ...
    -- Perform atomic swap
    UPDATE levels SET order_index = -1 WHERE id = level1_id;
    UPDATE levels SET order_index = level1_order WHERE id = level2_id;
    UPDATE levels SET order_index = level2_order WHERE id = level1_id;
END;
$$;
